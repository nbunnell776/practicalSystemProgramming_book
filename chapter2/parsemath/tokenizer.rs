/// This module reads characters in arithmetic expressions and converts them to tokens.
...
sue super::token::Token;

// Other structs

// Tokenizer struct contains a Peekable iterator on the arithemetic expression 
pub struct Tokenizer<'a> {
    expr: Peekable<Chars<'a>>,
}

// Constructs a new instance of Tokenizers
impl<'a> Tokenizer<'a> {
